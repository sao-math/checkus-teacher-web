        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-bold text-gray-900">{selectedClass.name} 대시보드</h1>
              <Badge 
            ...
            <p className="text-gray-600 mt-1">담당: {selectedClass.teacher}</p>
          </div>
        </div>
        <Button 
          variant="outline"
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{selectedClass.studentCount}명</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{dashboardData.attendance.today}명</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{dashboardData.assignments.completed}/{dashboardData.assignments.total}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{dashboardData.performance.average}점</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <Progress value={dashboardData.attendance.thisWeek} className="h-3" />
            </div>
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span>이번 달 출석률</span>
              ...
              <Progress value={dashboardData.attendance.thisMonth} className="h-3" />
            </div>
          </CardContent>
        </Card>
